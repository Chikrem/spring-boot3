...
public class MedicoRepositoryTest {
    ...
    @Test
    @DisplayName("Deveria devolver um médico disponível quando há médicos livres na data")
    void escolherMedicoAleatorioLivreNaDataCenario2() {
        var proximaSegundaAs10 = LocalDate.now()
                .with(TemporalAdjusters.next(DayOfWeek.MONDAY))
                .atTime(10, 0);

        var medico = cadastrarMedico("Medico Disponivel", "disponivel@voll.med", "123456", Especialidade.CARDIOLOGIA);
    ...
    @Test
    @DisplayName("Deveria devolver null quando não há médicos com a especialidade solicitada")
    void escolherMedicoAleatorioLivreNaDataCenario3() {
        var proximaSegundaAs10 = LocalDate.now()
                .with(TemporalAdjusters.next(DayOfWeek.MONDAY))
                .atTime(10, 0);

        cadastrarMedico("Medico", "medico@voll.med", "123456", Especialidade.ORTOPEDIA);
