...
class ConsultaControllerTest {
    ...
    @Test
    @DisplayName("Deveria devolver codigo http 403 quando usuario nao esta autenticado")
    ...
    @Test
    @DisplayName("Deveria devolver codigo http 404 quando medico ou paciente nao existe")
    @WithMockUser
